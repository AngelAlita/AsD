...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image = Image.open(os.path.join(self.image_folder, image_file)).resize((336,336)).convert('RGB')
        ...
        if self.args.AsD:
            AsD_image = Image.open(args.noise_img_path).convert("RGB")
...
def create_data_loader(args,questions, image_folder, tokenizer, image_processor, model_config, batch_size=1, num_workers=4):
    ...
    dataset = CustomDataset(questions, image_folder, tokenizer, image_processor, model_config,args=args)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--noise_img_path", type=str, default='./images/L2_noNorm_clipgrad_tips_336_LR0_1-1_1.png') 
